...
func init() {
	proto.RegisterType((*Request)(nil), "selfcachepb.Request")
	proto.RegisterType((*Response)(nil), "selfcachepb.Response")
}

func init() { proto.RegisterFile("selfcachepb.proto", fileDescriptor_889d0a4ad37a0d42) }
